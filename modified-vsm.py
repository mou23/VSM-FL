# python modified-vsm.py jdt ../jdt-merged.xml ../../jdt ./non-bugs-id-jdt.txt > output-jdt.txt
...
def filter_files(code_base_path, storage_path):
    ...
    if os.path.exists(os.path.join(storage_path, "code_data.json")):
        with open(os.path.join(storage_path, "code_data.json"), "r+", encoding="utf8", errors="ignore") as f:
            code_data = json.load(f)
